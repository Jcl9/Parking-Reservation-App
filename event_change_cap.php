...
$CapAllowed=$_POST['CapAllowed'];


include('connect.php');
$add_query="UPDATE GARAGE_LEVEL_EVENT_DATE SET CapAllowed = '$CapAllowed' WHERE Event_id = '$Event_id' AND Gar_level = '$Gar_level' AND Gar_id = '$Gar_id' ";
